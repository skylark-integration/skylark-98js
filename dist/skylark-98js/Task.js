 ...
 * @license MIT
 */
define(["skylark-jquery","./win98"],function(e,t){function s(t){s.all_tasks.push(this),this.$window=t;const i=this.$task=e("<button class='task toggle'/>").appendTo(e(".tasks")),n=e("<span class='title'/>");let o;this.updateTitle=(()=>{n.text(t.getTitle())}),this.updateIcon=(()=>{const e=o;(o=t.getIconAtSize(16))?e?e.replaceWith(o):i.prepend(o):e&&e.remove()}),this.updateTitle(),this.updateIcon(),t.on("title-change",this.updateTitle),t.on("icon-change",this.updateIcon),t.setMinimizeTarget(i[0]),i.append(o,n),i.on("pointerdown",function(e){e.preventDefault()}),i.on("click",function(){i.hasClass("selected")?(t.minimize(),t.blur()):(t.unminimize(),t.bringToFront(),t.focus())}),t.on("focus",()=>{i.addClass("selected")}),t.on("blur",()=>{i.removeClass("selected")}),t.on("closed",()=>{i.remove();const e=s.all_tasks.indexOf(this);-1!==e&&s.all_tasks.splice(e,1)}),t.is&&t.is(":visible")&&t.focus()}return s.all_tasks=[],s});
