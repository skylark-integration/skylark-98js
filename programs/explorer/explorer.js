		...
		const template_file_name =
			address === "/recycle-bin/" ? "recycle.htt" :
				address === "/network-neighborhood/" ? "nethood.htt" :
					...
					"FOLDER.HTT";
		template_url = new URL(`../lib/os-98/WEB/${template_file_name}`, location.href);
...
${doc.documentElement.outerHTML}`;
	...
	const head_end_injected_html = `
		<link href="/layout.css" rel="stylesheet" type="text/css">
		<link href="/classic.css" rel="stylesheet" type="text/css">
		<link href="/programs/lib/os-gui/layout.css" rel="stylesheet" type="text/css">
		<link href="/programs/lib/os-gui/windows-98.css" rel="stylesheet" type="text/css">
		<meta name="viewport" content="width=device-width, user-scalable=no">
		<script src="/programs/lib/jquery.min.js"></script>
		<script src="/programs/lib/os-gui/$Window.js"></script>
		<script src="/programs/lib/os-98/msgbox.js"></script>
